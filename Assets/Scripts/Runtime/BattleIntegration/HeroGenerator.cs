...
public class HeroGenerator : MonoBehaviour
{
    ...
    public HeroUnit GenerateHero(HeroBattler data, ModelRegistory modelRegistory)
    {
        ...
        heroModel.Initialize(data.BaseData, motionController);
        modelRegistory.RegisterModel(hero, heroModel);
